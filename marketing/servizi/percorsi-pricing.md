# Percorsi e Pricing — Studio Mantovan

> File di riferimento per Claude Code. Usare quando si crea o aggiorna la sezione "Percorsi" del sito, preventivi, contenuti social o qualsiasi comunicazione che riguardi l'offerta dello studio.

---

## 1. Filosofia del sistema — perché mesi, non sedute

Il mercato fisioterapico comunica quasi universalmente in "pacchetti da X sedute". Studio Mantovan rifiuta questo modello per una ragione clinica precisa: **le linee guida internazionali per il trattamento conservativo dei disturbi muscolo-scheletrici parlano di settimane, mesi, a volte anni — mai di un numero fisso di sedute**.

Un percorso di riabilitazione post-operatoria richiede mesi di lavoro progressivo. Un dolore cronico ha bisogno di tempo per essere rieducato, non di un contatore di appuntamenti. Strutturare l'offerta su un numero di sedute è clinicamente disonesto e comunica implicitamente che la guarigione è lineare e prevedibile, cosa che non è mai vera.

Il sistema percorsi di Studio Mantovan è costruito attorno al **tempo clinico**: la durata e la frequenza consigliata emergono dalla valutazione iniziale e riflettono ciò che la letteratura indica come necessario per quella specifica condizione. Il paziente non compra sedute — entra in un percorso.

Questo è anche coerente con l'approccio CFT (Cognitive Functional Therapy): il paziente è protagonista del proprio recupero, il tempo è parte del processo terapeutico, e l'autonomia progressiva è l'obiettivo, non la dipendenza dallo studio.
